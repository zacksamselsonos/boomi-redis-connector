...
/**
 * Represents a logical Redis String object type during connector browsing operations
 */
public class RedisStringObject extends RedisObjectType {
     ...
     */
    protected RedisStringObject(String id, String label, String helpText) {
